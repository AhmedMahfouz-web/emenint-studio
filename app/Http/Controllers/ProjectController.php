...
class ProjectController extends Controller
{
    public function show($slug)
    {
        ...
        $templateName = $project->serviceCategory->template_name ?? 'default';
        $viewPath = "front.projects.templates.{$templateName}";

        if (!view()->exists($viewPath)) {
            $viewPath = 'front.projects.templates.default';
        }

        return view($viewPath, compact('project', 'blocks'));
    }
    ...
    public function category($categorySlug)
    {
        ...
        return view('front.projects.category', compact('category', 'projects'));
    }
}
